  ...
  return (
    <Link href={href}>
      <Card
        ...
        <div className="absolute inset-0 bg-linear-to-r from-purple-400/0 via-violet-400/10 to-purple-400/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        ...
        <CardContent className="relative">
          <span className="text-sm font-semibold text-purple-600 group-hover:text-purple-700 inline-flex items-center gap-1">
            Learn More
